...
bool AsoUtility::IsCollisionBoxCircle(const Vector2& _pos1, const  Vector2& _size1, const  Vector2& _pos2, const  float _radius)
{
...
Vector2 AsoUtility::V2Sub(const Vector2& _pos1, const  Vector2& _pos2)
{
    Vector2 pos;
